...
const CONTROL_HINT_KEYBOARD := "W/S + ↑/↓ tracks   Y/H swing   U/J boom   I/K arm   O/L bucket   1–4 views"
const CONTROL_HINT_GAMEPAD := "Sticks: swing/boom/arm   Triggers: bucket   D-pad: views   Keyboard: tracks"
