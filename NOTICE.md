...
License retained at `godot/client/addons/terrain_3d/LICENSE.txt`. The production
construction-site height/control maps and terrain textures are generated by
ExcavatorSim project code; Terrain3D demo textures and scenes are not production
runtime inputs.
